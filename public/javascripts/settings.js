...
const incrementBtn = document.getElementById("increment-timer");
const decrementBtn = document.getElementById("decrement-timer");
...
decrementBtn.addEventListener("click", () => {
    const newValue = parseInt(timerInput.value) - 1;
    timerInput.value = newValue < 0 ? 0 : newValue;
});
