...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (savedFontSize) {
      document.documentElement.style.fontSize = savedFontSize;
        ...
        // Get score data from localStorage - fix to use the correct keys
        const score = parseInt(localStorage.getItem('quiz_score') || 0);
        const totalQuestions = parseInt(localStorage.getItem('total_questions') || 10);
        ...
        // Actually set the text content - display the percentage
        if (scorePercentage) {
        ...
        // Change content based on percentage score
        const scoreNum = percentage;
